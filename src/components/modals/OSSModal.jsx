...
export default function OSSModal(props) {
    return (<>
        <GenericModal {...props}>
            <p>Quarky uses music by <a href={"https://www.hurtrecord.com/"}>HURT RECORD</a>. Quarky also uses the following open source libraries (this list includes developer dependencies):</p>
            <OSSList />
        </GenericModal>
    </>)
}